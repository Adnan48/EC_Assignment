...
export async function readDataFromDisk(){
  ...
  try {
    ...
    if(value !== null) {
      dispatch({type: ActionType.READ_DATA_FROM_DISK, payload: JSON.parse(value)})
    }
  } catch(e) {
    // error reading value
  }
...
function fetchNews(){
  return axios.get(`https://newsapi.org/v2/everything?q=bitcoin&from=2020-04-25&sortBy=publishedAt&apiKey=1848b5465b1449d78d10c2991b1bea98`)
}